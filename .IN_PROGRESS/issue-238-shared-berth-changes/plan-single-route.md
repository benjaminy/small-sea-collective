# Historical plan: shared berth allocation and a single route

Historical snapshot preserved on 2026-09-08.
The active direction and next work are in [plan.md](plan.md).
Checkpoints and recommendations below describe the preceding single-route investigation and are not current work instructions.
