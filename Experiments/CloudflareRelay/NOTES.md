...
Record Cloudflare documentation findings here before any account-backed smoke testing.

## Cost Model

Record back-of-envelope costs for the plan's required scenarios here.

## Privacy And Metadata

Record payload-visibility findings separately from metadata-visibility findings.
