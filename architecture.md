...
Throughout Small Sea, **steward** is shorthand for a teammate in automatic mode on Core, evaluated relative to an accepted Core state; it is not a central authority or a special key class.
...
There is no central membership oracle and no globally authoritative steward
