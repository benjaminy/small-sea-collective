...
In particular Harmonic Merge is intended to work with a few patterns:
...
2. Rather than merging raw stored data, prefer an export/canonicalize, merge, import cycle.
   - Canonicalizing data make it easier for simple merge algorithms to perform well.
   - Harmonic Merge is not designed for low-latency use cases (e.g. real-time collaborative editing), but cases where it is okay to trade speed for accuracy and reliability.
