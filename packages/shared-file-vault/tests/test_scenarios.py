...
def setup_participant(playground, name, participant_hex):
    ...
    init_vault(str(root), participant_hex, TEAM)
    create_niche(str(root), participant_hex, TEAM, NICHE)
    checkout_niche(str(root), participant_hex, TEAM, NICHE, str(checkout))
...
def test_two_participants_converge(playground_dir):
    ...
    publish(str(alice_root), ALICE, TEAM, NICHE, message="initial commit")
    ...
    publish(str(alice_root), ALICE, TEAM, NICHE, message="add alice_notes")
    do_push(alice_root, ALICE, alice_cloud)

    write(bob_co, "bob_notes.txt", "Bob's design sketches.\n")
    publish(str(bob_root), BOB, TEAM, NICHE, message="add bob_notes")
...
def test_concurrent_text_edits_auto_merge(playground_dir):
    ...
    publish(str(alice_root), ALICE, TEAM, NICHE, message="initial plan")
    do_push(alice_root, ALICE, alice_cloud)
    ...
    publish(str(alice_root), ALICE, TEAM, NICHE, message="clarify overview")
    do_push(alice_root, ALICE, alice_cloud)
    ...
    publish(str(bob_root), BOB, TEAM, NICHE, message="fill in next steps")
    do_push(bob_root, BOB, bob_cloud)
...
def test_rename_and_concurrent_edit(playground_dir):
    ...
    publish(str(alice_root), ALICE, TEAM, NICHE, message="add proposal")
    do_push(alice_root, ALICE, alice_cloud)
    ...
    publish(str(alice_root), ALICE, TEAM, NICHE, message="move proposal to final/")
    do_push(alice_root, ALICE, alice_cloud)
    ...
    publish(str(bob_root), BOB, TEAM, NICHE, message="add conclusion")
    do_push(bob_root, BOB, bob_cloud)
...
def test_three_participant_gossip(playground_dir):
    ...
    publish(str(alice_root), ALICE, TEAM, NICHE, message="add glossary")
    do_push(alice_root, ALICE, alice_cloud)
    ...
    publish(str(bob_root), BOB, TEAM, NICHE, message="add architecture notes")
    do_push(bob_root, BOB, bob_cloud)
    ...
    publish(str(carol_root), CAROL, TEAM, NICHE, message="add carol's ideas")
...
def test_concurrent_edit_same_line_raises(playground_dir):
    ...
    publish(str(alice_root), ALICE, TEAM, NICHE, message="initial title")
    do_push(alice_root, ALICE, alice_cloud)
    ...
    publish(str(alice_root), ALICE, TEAM, NICHE, message="name it SmallSea")
    do_push(alice_root, ALICE, alice_cloud)

    write(bob_co, "title.txt", "Project Name: Wavelength\n")
    publish(str(bob_root), BOB, TEAM, NICHE, message="name it Wavelength")
    do_push(bob_root, BOB, bob_cloud)
