...
- "steward" remains Manager shorthand for automatic Core integration; protocol rules should name the versioned analysis basis when they mean causal-context-relative standing, not a special key role
